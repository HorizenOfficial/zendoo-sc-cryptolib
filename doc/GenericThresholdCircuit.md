...
$$\begin{split} x &= \sum_{k=0}^{d-1}b_k \cdot 2^k \\ 0 &= b_k \cdot (b_k-1), \qquad k=0, \ldots ,d-1\end{split}$$
...
$$\begin{split} x &= b_0+b_1 \cdot 2+ \dots + b_d\cdot 2^{d-1} \bmod r,\\0 &= b_i \cdot (1-b_i) \bmod r, \qquad i=0,\ldots,d-1\end{split}$$
