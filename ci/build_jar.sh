...
RUSTFLAGS="-C target-feature=+bmi2,+adx --emit=asm" cargo +nightly-2020-04-22 build -j$(($(nproc)+1)) --release --target=x86_64-pc-windows-gnu
RUSTFLAGS="-C target-feature=+bmi2,+adx --emit=asm" cargo +nightly-2020-04-22 build -j$(($(nproc)+1)) --release --target=x86_64-unknown-linux-gnu
