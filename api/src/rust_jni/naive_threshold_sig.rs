...
use demo_circuit::{generate_circuit_keypair, get_instance_for_setup};
    ...
    fn Java_com_horizen_sigproofnative_NaiveThresholdSigProof_nativeCreateMsgToSign(
        ...
        if bt_list_size > 0 {
            for i in 0..bt_list_size {
                ...
                .try_into()
                .unwrap(); // Cannot fail if parse_fixed_jbyte_array passed
        ...
        let sc_id =
            parse_rust_struct_from_jobject::<FieldElement>(&_env, _sc_id, "fieldElementPointer");
        let end_cumulative_sc_tx_comm_tree_root = parse_rust_struct_from_jobject::<FieldElement>(
            &_env,
