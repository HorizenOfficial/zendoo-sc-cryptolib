...
pub type SchnorrSigScheme = FieldBasedSchnorrSignatureScheme<FieldElement, G2, FieldHash>;
pub type SchnorrSig = FieldBasedSchnorrSignature<FieldElement, G2>;
pub type SchnorrPk = G2;
pub type SchnorrSk = ScalarFieldElement;

pub type GroupHash = BoweHopwoodPedersenCRH<G2, VRFWindow>;

pub type VRFScheme = FieldBasedEcVrf<FieldElement, G2, FieldHash, GroupHash>;
pub type VRFProof = FieldBasedEcVrfProof<FieldElement, G2>;
pub type VRFPk = G2;
